...
from zbdpay._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: ZbdPayments | AsyncZbdPayments) -> int:
...
class TestZbdPayments:
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
    ...
    def test_copy(self, client: ZbdPayments) -> None:
        copied = client.copy()
        assert id(copied) != id(client)

        copied = client.copy(apikey="another My Apikey")
        assert copied.apikey == "another My Apikey"
        assert client.apikey == "My Apikey"

    def test_copy_default_options(self, client: ZbdPayments) -> None:
    ...
    def test_copy_signature(self, client: ZbdPayments) -> None:
    ...
    def test_copy_build_request(self, client: ZbdPayments) -> None:
    ...
    def test_request_timeout(self, client: ZbdPayments) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_validate_headers(self) -> None:
        client = ZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=True)
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("apikey") == apikey

        with update_env(**{"ZBD_PAYMENTS_API_KEY": Omit()}):
            client2 = ZbdPayments(base_url=base_url, apikey=None, _strict_response_validation=True)

        with pytest.raises(
            TypeError,
            match="Could not resolve authentication method. Expected the apikey to be set. Or for the `apikey` headers to be explicitly omitted",
        ):
            client2._build_request(FinalRequestOptions(method="get", url="/foo"))

        request2 = client2._build_request(FinalRequestOptions(method="get", url="/foo", headers={"apikey": Omit()}))
        assert request2.headers.get("apikey") is None
    ...
    def test_hardcoded_query_params_in_url(self, client: ZbdPayments) -> None:
    ...
    def test_request_extra_json(self, client: ZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: ZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: ZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: ZbdPayments) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_non_application_json_content_type_for_json_data(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
        """
    ...
    def test_base_url_setter(self) -> None:
        client = ZbdPayments(base_url="https://example.com/from_init", apikey=apikey, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(ZBD_PAYMENTS_BASE_URL="http://localhost:5000/from/env"):
            client = ZbdPayments(apikey=apikey, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            ZbdPayments(base_url="http://localhost:5000/custom/path/", apikey=apikey, _strict_response_validation=True),
            ZbdPayments(
    ...
    def test_base_url_trailing_slash(self, client: ZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: ZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: ZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = ZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            ZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = ZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = ZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=False)
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: ZbdPayments
    ) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
        respx_mock.post("/v0/ln-address/send-payment").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.lightning_address.with_streaming_response.send_payment().__enter__()

        assert _get_open_connections(client) == 0

    @mock.patch("zbdpay._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v0/ln-address/send-payment").mock(side_effect=retry_handler)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: ZbdPayments) -> None:
...
class TestAsyncZbdPayments:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncZbdPayments) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncZbdPayments) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncZbdPayments) -> None:
        copied = async_client.copy()
        assert id(copied) != id(async_client)

        copied = async_client.copy(apikey="another My Apikey")
        assert copied.apikey == "another My Apikey"
        assert async_client.apikey == "My Apikey"

    def test_copy_default_options(self, async_client: AsyncZbdPayments) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncZbdPayments) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncZbdPayments) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncZbdPayments) -> None:
    ...
    def test_validate_headers(self) -> None:
        client = AsyncZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=True)
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("apikey") == apikey

        with update_env(**{"ZBD_PAYMENTS_API_KEY": Omit()}):
            client2 = AsyncZbdPayments(base_url=base_url, apikey=None, _strict_response_validation=True)
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncZbdPayments) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncZbdPayments) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncZbdPayments) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, async_client: AsyncZbdPayments
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncZbdPayments) -> None:
        class Model1(BaseModel):
            name: str
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_union_response_different_types(self, respx_mock: MockRouter, async_client: AsyncZbdPayments) -> None:
        """Union of objects with the same field name using a different type"""
    ...
    async def test_base_url_env(self) -> None:
        with update_env(ZBD_PAYMENTS_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncZbdPayments(apikey=apikey, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_base_url_trailing_slash(self, client: AsyncZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        non_strict_client = AsyncZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=False)
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncZbdPayments
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.lightning_address.with_streaming_response.send_payment().__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.lightning_address.with_raw_response.send_payment()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncZbdPayments, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncZbdPayments) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncZbdPayments) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
