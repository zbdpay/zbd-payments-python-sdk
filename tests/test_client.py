...
from zbd_payments import ZbdPayments, AsyncZbdPayments, APIResponseValidationError
from zbd_payments._types import Omit
from zbd_payments._utils import maybe_transform
from zbd_payments._models import BaseModel, FinalRequestOptions
from zbd_payments._constants import RAW_RESPONSE_HEADER
from zbd_payments._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from zbd_payments._base_client import (
    DEFAULT_TIMEOUT,
    HTTPX_DEFAULT_TIMEOUT,
    BaseClient,
    make_request_options,
)
from zbd_payments.types.lightning_address_send_payment_params import LightningAddressSendPaymentParams
...
class TestZbdPayments:
    ...
    def test_copy(self) -> None:
        ...
        copied = self.client.copy(apikey="another My Apikey")
        assert copied.apikey == "another My Apikey"
        assert self.client.apikey == "My Apikey"
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "zbd_payments/_legacy_response.py",
                        "zbd_payments/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "zbd_payments/_compat.py",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = ZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=False)
    ...
    @mock.patch("zbd_payments._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                ...
                body=cast(
                    object,
                    maybe_transform(
                        dict(amount="500000", comment="Instant global payments", ln_address="andreneves@zbd.gg"),
...
class TestAsyncZbdPayments:
    ...
    def test_base_url_trailing_slash(self, client: AsyncZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncZbdPayments) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncZbdPayments(base_url=base_url, apikey=apikey, _strict_response_validation=False)
    ...
    def test_get_platform(self) -> None:
        ...
        from zbd_payments._utils import asyncify
        from zbd_payments._base_client import get_platform
